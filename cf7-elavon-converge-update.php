 ...
 * Contact Form 7 - elavon Extension Update Notifier
...
add_action( 'init', 'activate_elavon_update' );	

function activate_elavon_update()

{
	...
	$plugin_remote_path = 'http://opensource.zealousweb.com/updates/cf7se.php';	

	$plugin_slug = plugin_basename( __FILE__ );

	new WP_elavon_AutoUpdate ( $plugin_current_version, $plugin_remote_path, $plugin_slug );
	*/
